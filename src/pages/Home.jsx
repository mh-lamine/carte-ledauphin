  ...
  return (
    <div className="p-4">
      <div className="relative rounded-sm overflow-hidden shadow-md">
        <Link to="/brasserie">
          <h2 className="uppercase font absolute bottom-0 text-6xl font-extrabold font-mono tracking-wider mix-blend-overlay text-white p-2">
            Brasserie
          </h2>
      ...
      <div className="relative rounded-sm overflow-hidden shadow-md">
        <Link to="/restaurant">
          <h2 className="uppercase font absolute text-6xl font-semibold font-mono tracking-wider mix-blend-overlay text-white p-2">
            Restaurant
          </h2>
