  ...
  return (
    <div className="p-4">
      <div className="relative rounded-sm overflow-hidden shadow-md">
        <Link to="/brasserie">
          <h2 className="uppercase absolute bottom-0 text-5xl font-extrabold font-mono tracking-wider mix-blend-overlay text-white p-2">
            Brasserie
          </h2>
      ...
      <div className="relative rounded-sm overflow-hidden shadow-md">
        <Link to="/restaurant">
          <h2 className="uppercase absolute text-5xl font-extrabold font-mono tracking-wider mix-blend-overlay text-white p-2">
            Restaurant
          </h2>
